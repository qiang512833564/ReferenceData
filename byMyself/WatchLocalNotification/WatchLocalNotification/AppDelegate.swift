...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func addLocalNotifiation()
    {
        var localNotific = UILocalNotification()
        localNotific.fireDate = NSDate(timeIntervalSinceNow: 1.0)
        localNotific.alertBody = "该吃药了"
        localNotific.alertAction = "打开应用"
        //localNotific.repeatInterval = NSCalendarUnit(2)
        localNotific.soundName = UILocalNotificationDefaultSoundName
