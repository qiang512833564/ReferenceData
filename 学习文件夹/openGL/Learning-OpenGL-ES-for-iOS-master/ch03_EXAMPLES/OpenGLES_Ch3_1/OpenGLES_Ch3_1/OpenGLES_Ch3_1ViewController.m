...
- (void)viewDidLoad
{
   ...
   GLKTextureInfo *textureInfo = [GLKTextureLoader 
      ...
      options:nil 
      error:NULL];//GLKTextureInfo类封装了与刚创建的纹理缓存相关的信息，包括它的 尺寸以及它是否包含MIP贴图
                 // GLKTextureInfo的targe属性指定被配置的纹理缓存的类型
    
   /*
    纹理
    */
   self.baseEffect.texture2d0.name = textureInfo.name;//使用一个新的纹理缓存
